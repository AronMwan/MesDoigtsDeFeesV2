using MesDoigtsDeFees.ApiModels;
...
namespace MesDoigtsDeFees.ApiControllers
{
    ...
    {
        SignInManager<MesDoigtsDeFeesUser> _signInManager;

        public AccountsController(SignInManager<MesDoigtsDeFeesUser> signInManager)
        {
