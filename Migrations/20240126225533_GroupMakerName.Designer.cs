...
namespace MesDoigtsDeFees.Migrations
{
    ...
    [Migration("20240126225533_GroupMakerName")]
    partial class GroupMakerName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MesDoigtsDeFees.Models.Group", b =>
                {
                    ...
                    b.HasIndex("GroupMakerId");

                    b.ToTable("Groups");
                });

            modelBuilder.Entity("MesDoigtsDeFees.Models.Language", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(2)
            ...
            modelBuilder.Entity("MesDoigtsDeFees.Models.Group", b =>
                {
                    b.HasOne("MesDoigtsDeFees.Areas.Identity.Data.MesDoigtsDeFeesUser", "GroupMaker")
                        .WithMany()
                        .HasForeignKey("GroupMakerId");

                    b.Navigation("GroupMaker");
                });
